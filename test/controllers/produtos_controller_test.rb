...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { custo: @produto.custo, fabricante_id: @produto.fabricante_id, nome: @produto.nome, tipoproduto_id: @produto.tipoproduto_id }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { custo: @produto.custo, fabricante_id: @produto.fabricante_id, nome: @produto.nome, tipoproduto_id: @produto.tipoproduto_id }
    assert_redirected_to produto_path(assigns(:produto))
  end
