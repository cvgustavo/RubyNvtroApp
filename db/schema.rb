...
ActiveRecord::Schema.define(version: 20150123032048) do
  ...
  create_table "etapanes", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "prescricaone_id"
  end

  add_index "etapanes", ["prescricaone_id"], name: "index_etapanes_on_prescricaone_id", using: :btree
