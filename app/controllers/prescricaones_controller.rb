class PrescricaonesController < ApplicationController
  ...
  private
    ...
    def prescricaone_params
      params.require(:prescricaone).permit(:data, :custo, :valorfaturado, :paciente_id, :internacao_id, :nutricionista, :equipo, :autorizacaourl, :contamedicaurl, :checagemurl, :entregaurl, :motoqueiro)
    end
end
